...
from utils import get_custom_callback, to_multi_label, best_lr_decay, f1_m, multi_label_acc, kappa_loss_tefla
import sys
...
def main():
    ...
    model.compile(loss=kappa_loss_tefla,
                  # optimizer=optimizers.Adam(lr=0.0001,decay=1e-6),
                  optimizer=optimizers.SGD(lr=0.0001, momentum=0.9),
                  metrics=[f1_m, multi_label_acc])
